...
if __name__ == '__main__':
    ...
    graph_select_1.plot_and_show(values=values_select_2, graph_precision=125, title='Tempo médio de execução SELECT 2', font_size=font_size, x_label='Tipo de Índice', y_label='Tempo médio (Em MS)')
    graph_select_1.plot_and_show(values=values_select_3, graph_precision=100, title='Tempo médio de execução SELECT 3', font_size=font_size, x_label='Tipo de Índice', y_label='Tempo médio (Em MS)')
    ...
    labels = ['HASH', 'BTREE', 'BRIN', 'GIN', 'GIST']
